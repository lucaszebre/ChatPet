...
CREATE TABLE `chat` (
	...
	`userId` text NOT NULL,
	`createdAt` integer NOT NULL,
	`updateAt` integer DEFAULT '"2025-10-13T21:36:27.787Z"' NOT NULL,
...
CREATE TABLE `message` (
	...
	`createdAt` integer DEFAULT '"2025-10-13T21:36:27.787Z"' NOT NULL,
...
--> statement-breakpoint
CREATE UNIQUE INDEX `image_messageId_unique` ON `image` (`messageId`);