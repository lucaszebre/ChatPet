...
CREATE TABLE `chat` (
	...
	`userId` text NOT NULL,
	`createdAt` integer NOT NULL,
	`updateAt` integer DEFAULT '"2025-10-14T09:12:49.405Z"' NOT NULL,
...
--> statement-breakpoint
CREATE UNIQUE INDEX `image_messageId_unique` ON `image` (`messageId`);--> statement-breakpoint
CREATE TABLE `jwks` (
	`id` text PRIMARY KEY NOT NULL,
...
CREATE TABLE `message` (
	...
	`createdAt` integer DEFAULT '"2025-10-14T09:12:49.405Z"' NOT NULL,
